...
func newApp(ctx context.Context, port, projectID string) (*App, error) {
	...
	r.HandleFunc("/", app.Handler).
		Methods("GET")
	r.HandleFunc("/api/v1/customer/get", app.Handler2).
		Methods("POST")
	r.HandleFunc("/customer-service-sync/api/v1/customer/get", app.Handler2).
		Methods("POST")
	r.HandleFunc("/api/v1/customer/limit", app.Handler3).
		Methods("POST")
	r.HandleFunc("/customer-service-sync/api/v1/customer/limit", app.Handler3).
		Methods("POST")
	r.HandleFunc("/api/v1/customer/reserve", app.Handler4).
		Methods("POST")
	r.HandleFunc("/customer-service-sync/api/v1/customer/reserve", app.Handler4).
		Methods("POST")
